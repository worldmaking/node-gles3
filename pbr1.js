...
let material = loadMaterialTextures(gl, "metal") 
...
win.draw = function() {
	...
	mat4.rotateX(modelmatrix, modelmatrix, t/2)
	mat4.rotateY(modelmatrix, modelmatrix, t/3)
	shaderman.shaders.pbr1.uniform("u_modelmatrix", modelmatrix)
	cube.bind().draw().unbind()
	

	
	mat4.identity(modelmatrix)
	mat4.translate(modelmatrix, modelmatrix, [-5, 1, 0])
	mat4.rotateX(modelmatrix, modelmatrix, t/2)
	mat4.rotateY(modelmatrix, modelmatrix, t/3)
	shaderman.shaders.pbr1.uniform("u_modelmatrix", modelmatrix)
	cube.bind().draw().unbind()
	...
	mat4.identity(modelmatrix)
	mat4.translate(modelmatrix, modelmatrix, [0, 1, 5])
	shaderman.shaders.pbr1.uniform("u_modelmatrix", modelmatrix)
	cube.bind().draw().unbind()
